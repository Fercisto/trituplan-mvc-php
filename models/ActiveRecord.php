...
class ActiveRecord {
    ...
    public function borrarImagen() {
        ...
        $imagen_jpg = trim($this->imagen) . ".jpg";
        $imagen_webp = trim($this->imagen) . ".webp";

        $existeArchivo_jpg = file_exists(CARPETA_IMAGENES . $imagen_jpg);
        $existeArchivo_webp = file_exists(CARPETA_IMAGENES . $imagen_webp);

        if($existeArchivo_jpg && $existeArchivo_webp) {
            unlink(CARPETA_IMAGENES . $imagen_jpg);
            unlink(CARPETA_IMAGENES . $imagen_webp);
        }
    }
